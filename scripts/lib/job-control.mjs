...
export function resolveResultJob(cwd, reference) {
  ...
  throw new Error("No finished Grok jobs found for this workspace yet.");
}
...
export function resolveCancelableJob(cwd, reference) {
  ...
  if (activeJobs.length > 1) throw new Error("Multiple Grok jobs are active. Pass a job id to /grok:cancel.");
